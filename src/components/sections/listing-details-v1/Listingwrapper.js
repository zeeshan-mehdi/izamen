...
import { OverlayTrigger, Tooltip, Dropdown, NavLink, Accordion, Container, Row, Col, Tab, Tabs, Modal, Card, Button } from 'react-bootstrap';
...
class Listingwrapper extends Component {
    ...
    componentDidMount() {
        ...
        try {
            ...
            {
                property_ID:this.props.lisitingdetailproperty.property_ID
            },
                {
                    headers: {
                ...
                .then(async (response) => {
                    ...
                    this.setState({ listinggallery: response.data });
        ...
        // { console.log("sasasadfasf", this.props.lisitingdetailproperty) }
    };
    render() {
        return (
            <div className="section listing-wrapper">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-8">
                            ...
                            <div className="listing-content">
                                ...
                                <div className="row">
                                    {this.state.listinggallery.map((item, i) => (
                                        <div key={i} className="col-md-6 mb-3">
                                            {/* <Link to={item.img} className="gallery-thumb"> */}
                                                <img src={item.img_path} alt="post" style={{width:"300px",height:"250px"}} />
                                            {/* </Link> */}
                                        </div>
                                    ))}
                                </div>
                        ...
                        <div className="col-lg-4">
                            <div className="sidebar sticky-sidebar">
                                <div className="sidebar-widget">
                                    {this.props.lisitingdetailproperty.agent_ID != 0 && this.props.lisitingdetailproperty.agent_ID != "0" && this.props.lisitingdetailproperty.agent_ID != null && this.props.lisitingdetailproperty.agent_ID != ""
                                        ? (
                                            <>
                                                ...
                                                <div className="media sidebar-author listing-agent">
                                                    ...
                                                    <div className="media-body">
                                                        <h6> <Link to="#">{this.props.lisitingdetailproperty.agent_firstName + " " + this.props.lisitingdetailproperty.agent_lastName}</Link> </h6>
                                                    </div>
                                                    {/* <Dropdown className="options-dropdown">
                                                <Dropdown.Toggle as={NavLink}><i className="fas fa-ellipsis-v" /></Dropdown.Toggle>
                                                <Dropdown.Menu className="dropdown-menu-right">
                                                ...
                                                <button className="btn-custom" style={{ width: '100%' }} onClick={() => { this.setState({ showwebdisplaymodel: true }) }} >Contact Details</button>
                                                ...
                                                (
                                                    <button className="btn-custom" style={{ width: '100%' }} onClick={() => {
                                                        try {
                                                            ...
                                                            axios.post(globalvariables.data.Basicapi + "updateProperty",
                                                                {
                                                                    property_ID: this.props.lisitingdetailproperty.property_ID,
                                                                    agent_ID: this.props.userProfile.agent_ID,
                                                                    address: this.props.lisitingdetailproperty.address,
                                                                    city: this.props.lisitingdetailproperty.city,
                                                                    country: this.props.lisitingdetailproperty.country,
                                                                    lat: this.props.lisitingdetailproperty.lat,
                                                                    long: this.props.lisitingdetailproperty.long,
                                                                    area: this.props.lisitingdetailproperty.area,
                                                                    area_type: this.props.lisitingdetailproperty.area_type,
                                                                    property_type: this.props.lisitingdetailproperty.property_type,
                                                                    property_purpose: this.props.lisitingdetailproperty.property_purpose,
                                                                    price: this.props.lisitingdetailproperty.price
                                                                ...
                                                                .catch(error => {
                                                                    alert("in catch of axios while submitting agent", error.toString());
                                                            ...
                                                            alert("in try catch while submitting agent", error.toString());
                ...
                <Modal show={this.state.showwebdisplaymodel} onHide={() => { this.setState({ showwebdisplaymodel: false }) }}>
                    ...
                    <Modal.Body>
                        ...
                        {localStorage.getItem("guestemail") != "" ? (
                            <>
                                <h4>Contact Number: {this.props.lisitingdetailproperty.agent_ContactNo}</h4>
                                <h4>Email: <span style={{ color: 'blue' }}>{this.props.lisitingdetailproperty.agent_Email}</span></h4>
                            </>
                        ) : (
                            <div className="comment-form">
                                <div className="row">
                                    ...
                                    <div className="col-md-6 form-group">
                                        ...
                                        <input type="text" className="form-control" placeholder="email" name="email" onChange={(event) => { this.setState({ email: event.target.value }) }} />
                                    </div>
                                    <div className="col-md-6 form-group">
                                        <label><span style={{ color: 'red' }}>*</span>Contact No</label>
                                        <input type="text" className="form-control" placeholder="contact" name="contact" onChange={(event) => { this.setState({ contactNo: event.target.value }) }} />
                                    </div>
                                </div>
                                <button className="btn-custom primary" onClick={() => {
                                    try {
                                        if (this.state.firstName === "" || this.state.email === "" || this.state.contactNo === "") {
                                            alert("Please add details First")
                                        }
                                        else {
                                            axios.post(globalvariables.data.Basicapi + "createGuest",
                                                {
                                                ...
                                                .then(async (response) => {
                                                    ...
                                                    this.setState({ showwebdisplaymodel: false })

                                                    setTimeout(() => {
                                                        this.setState({ showwebdisplaymodel: true })
                                                    }, 2000);

                                                })
                                                .catch(error => {
                                                    alert("in catch of axios while submitting guest", error.toString());

                                                });
                                        }
                                    } catch (error) {

                                        alert("in try catch while submitting guest", error.toString());
                    ...
                    <Modal.Footer>
                        <Button variant="secondary" onClick={() => { this.setState({ showwebdisplaymodel: false }) }}>
                            Close
          </Button>
