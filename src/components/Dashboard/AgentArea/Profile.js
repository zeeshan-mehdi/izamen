...
function Profile(props) {
    ...
    useEffect(async () => {
        try {
            ...
            const res = await axios.post(globalvariables.data.Basicapi + "getAgentOnUserID",
                {
    ...
    function updateprofile() {
        try {
            if (contactNo != "" || address != "" || city != "" || country != "" || postalCode != "") {
                let uid = localStorage.getItem("user_ID");
                axios.post(globalvariables.data.Basicapi + "updateAgent",
                    {
            ...
            <Col md={12}>
                ...
                <Row>
                    <Col md={6}>
                        ...
                        <input type="text" value={user.contactNo} name="contactno" className="form-control" placeholder="Contact No" onChange={(event) => { setcontactNo(event.target.value) }} />
                ...
                <Row>
                    <Col md={12}>
                        <label>Address</label>
                        <input type="text" value={user.address} name="address" className="form-control" placeholder="Address" onChange={(event) => { setaddress(event.target.value) }} />
                    </Col>
                </Row>
                <Row>
                    <Col md={4}>
                        <label>City</label>
                        <input type="text" value={user.city} name="city" className="form-control" placeholder="City" onChange={(event) => { setcity(event.target.value) }} />
                    </Col>
                    <Col md={4}>
                        <label>Country</label>
                        <input type="text" value={user.country} name="country" className="form-control" placeholder="Country" onChange={(event) => { setcountry(event.target.value) }} />
                    </Col>
                    <Col md={4}>
